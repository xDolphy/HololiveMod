...
import net.mcreator.hololivemodfortnite.client.model.Modelolliebeam;
...
public class HololivemodfortniteModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		event.registerLayerDefinition(Modelolliebeam.LAYER_LOCATION, Modelolliebeam::createBodyLayer);
